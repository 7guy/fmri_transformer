...
class Transformer(nn.Module):
    ...
    def __init__(self,device,voxels, d_model=100, n_head=1, max_len=327, seq_len=327,
                 ffn_hidden=128, n_layers=1, drop_prob=0.1, details = False):
        super().__init__() 
        self.device = device
        ...
        self.encoder = Encoder(d_model=d_model,
                               ...
                               details=details,
                               device=device)
        self.classHead = ClassificationHead(seq_len=seq_len,d_model=d_model,details=details,n_classes=15)
